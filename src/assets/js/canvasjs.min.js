    ...
    if (!ib) {
      ...
      if (k.creditHref && k.creditText) {
        ...
        if (0 === k.renderCount || p || D)
          k._creditLink.setAttribute('href', k.creditHref), (k._creditLink.innerHTML = k.creditText)
            ...
            0 < s &&
              (a.axisX.logarithmic
                ...
                : ((B = c - h.dataPoints[s - 1].x),
                  ...
                  b.minDiff > B && 0 !== B && (b.minDiff = B)),
              e &&
                null !== e[0] && h.dataPoints[s - 1].y && null !== h.dataPoints[s - 1].y[0] &&
                (a.axisY.logarithmic
      ...
      function d() {
        if (h && s) {
          ...
          for (d = 0; d < s.length; d++)
            (m = f[(e + d) % s.length]),
              1 < b &&
                m.midAngle > (3 * Math.PI) / 2 - t && m.midAngle < (3 * Math.PI) / 2 + t &&
                (l <= b / 2 && !q
                  ? ((m.hemisphere = 'left'), l++)
